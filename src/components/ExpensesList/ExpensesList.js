...
class ExpensesList extends React.Component {
    ...
    return (
      <React.Fragment>
        ...
        <input
          ...
          type="text"
          maxLength="15"
          className="expense-detail-input"
        ...
        <input
          ...
          type="number"
          maxLength="4"
          className="expense-detail-input expense-price-input"
          placeholder="Price"
          onChange={this.handleInputChange}
        ></input>
        <input
          name="date"
          type="date"
          className="expense-detail-input expense-date-input"
          placeholder="Date"
          onChange={this.handleInputChange}
        ></input>
        <button
          onClick={this.handleAddDeleteButtonClicked}
          disabled={this.state.addExpenseButtonDisabled}
          value={this.state.addOrDeleteExpense}
          className="btn btn-secondary add-expense-btn"
        >
          {this.state.addOrDeleteExpense}
        </button>
      </React.Fragment>
    );
  }
  ...
  addExpense = () => {
    this.setState(prevState => {
      ...
      newExpensesList.push({
        ...
        date: prevState.date,
        key: prevState.expensesList.length
      });
      let newState = {
  ...
  deleteExpense = () => {
    ...
    this.setState(prevState => {
      let newExpensesList = [...prevState.expensesList];
      let indexToDelete = newExpensesList.findIndex(
        expense =>
