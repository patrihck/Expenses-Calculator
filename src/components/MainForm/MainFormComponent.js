  ...
  return (
    <div>
      ...
      <div hidden={this.props.selectedView === "expenses" ? false : true}>
        <ExpensesFormContainer expensesGroups = {this.state.expensesGroups} onExpenseGroupAdded = {this.props.onExpenseGroupAdded}></ExpensesFormContainer>
      </div>
      <div hidden= {this.props.selectedView === "charts" ? false : true}>
        <ChartsFormContainer expenses={this.state.expensesGroups}></ChartsFormContainer>
      </div>
    </div>
  );
}
